...
//			System.out.println(dto.getContent());
			...
			System.out.println("BOARD 테이블에 값이 Insert 되었습니다.");
			
		}catch(Exception e) {
			e.printStackTrace();
			System.out.println("BOARD 테이블에 값 Insert 실패했습니다.");			
		}finally {
			// 사용한 객체를 제거함
...
//	BOARD_LIST_W = "select * from board where WRITER like '%'||?||'%' order by seq desc";
